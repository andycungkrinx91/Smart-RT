...
export async function GET(request: Request) {
  ...
  return proxyRequest('/datapenduduk', { method: 'GET' }, token)
}
...
export async function POST(request: Request) {
  ...
  return proxyRequest('/adddatapenduduk', { method: 'POST', body: JSON.stringify(body) }, token)
}
...
export async function PUT(request: Request) {
  ...
  return proxyRequest('/updatedatapenduduk', { method: 'PUT', body: JSON.stringify(body) }, token)
}
...
export async function DELETE(request: NextRequest) {
  ...
  return proxyRequest(`/deletedatapenduduk?id=${id}`, { method: 'DELETE' }, token)
}
