...
export async function GET(request: NextRequest) {
  ...
  const path = '/dataiuranwarga' + (searchParams ? '?' + searchParams : '')
...
export async function POST(request: Request) {
  ...
  return proxyRequest('/adddataiuranwarga', { method: 'POST', body: JSON.stringify(body) }, token)
}
...
export async function PUT(request: Request) {
  ...
  return proxyRequest('/updatedataiuranwarga', { method: 'PUT', body: JSON.stringify(body) }, token)
}
...
export async function DELETE(request: NextRequest) {
  ...
  return proxyRequest(`/deletedataiuranwarga?id=${id}`, { method: 'DELETE' }, token)
}
