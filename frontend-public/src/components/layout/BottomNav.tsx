...
export default function BottomNav() {
  ...
  // Reset menu when pathname changes
    ...
    <nav className="fixed inset-x-0 bottom-0 z-50 lg:hidden">
      <div className="relative w-full">
        ...
        <motion.div
          ...
          className="grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)_4.75rem_minmax(0,1fr)_minmax(0,1fr)] items-end gap-2 rounded-t-2xl border-t border-slate-800 bg-[#0a1020] px-2 pb-1 pt-0 shadow-[0_-8px_28px_rgba(0,0,0,0.4)]"
        >
          <Link
            href="/blogs"
